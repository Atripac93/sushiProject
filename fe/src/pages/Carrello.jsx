    ...
    <>
      <div className="container">
        <div className="flex items-center justify-between gap-3">
          <h1 className="font-bold text-black bg-orange-400 p-3 m-3">
            Sushi Cart
          </h1>
          <div className="text-white bg-black p-4 rounded-lg  font-bold">
            You pay € {getSommaPezzi().toFixed(2)}
          </div>
        </div>

        <ul className="flex flex-col items-center m-10 gap-10">
          <h1 className="text-orange-400">Cart List</h1>
          {carrello.map((sushi, index) => (
            <li className="font-bold text-3xl text-white " key={index}>
        ...
        <div className="flex gap-5 flex-wrap">
          {sushiData.map((sushi) => (
            <button
              key={sushi.id}
              className="bg-orange-400 text-black rounded-lg w-[200px] p-3 font-bold hover:scale-125 transition delay-100"
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-evenly items-baseline mt-6 mb-5">
            <Link to={"/PayPage"}>
              <button
                type="button"
